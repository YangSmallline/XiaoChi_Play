package com.xiaochi.player.model
    ...
    companion object CREATOR : Parcelable.Creator<AudioBean> {
        ...
        fun getAudioBean(cursor: Cursor?): AudioBean {
            ...
            if (cursor?.moveToNext()!!){
                ...
                audioBean.display_name = cursor.getString(cursor.getColumnIndexOrThrow(MediaStore.Audio.Media.DISPLAY_NAME))
                print(cursor.getColumnIndexOrThrow(MediaStore.Audio.Media.DISPLAY_NAME))
